...
--> Solution: client-side storage (browser storage: localStorage or indexedDB -> exploiting Same-Origin Policy + stored on the browser's local cache on the machine -> no hardcoded data) x static hosting (Github pages)
